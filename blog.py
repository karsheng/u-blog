...
class Post(db.Model):
    ...
    def render(self, uid):
        ...
        self._no_of_comments = Comment.get_by_post_id(
            str(self.key().id())).count()
...
class Like(db.Model):
    ...
    def user_liked(cls, post_id, uid=""):
        q = cls.gql("WHERE post_id = :post_id and uid = :uid",
                    post_id=post_id,
                    uid=uid)
        return q.get()
...
class Comment(db.Model):
    ...
    @classmethod
    def get_by_post_id(cls, post_id):
        q = cls.gql("WHERE post_id = :post_id ORDER BY created DESC",
                    post_id=post_id)
        return q
...
class BlogFront(BlogHandler):
    ...
    """
    Handler of the Blog Front Page
    List all posts ordered by date created.
    """
...
class PostPage(BlogHandler):
    ...
    # to check if user is authorized to proceed by comparing user_id
    # and the post associated user_id
    ...
    def get(self, post_id):
        ...
        # verified if the post is posted by currently logged in user
